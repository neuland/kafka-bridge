...
import de.neuland.kafkabridge.test.TemporaryDirectoryConfiguration;
...
import static de.neuland.kafkabridge.test.TemporaryDirectoryConfiguration.getTemporaryDirectory;
...
@ContextConfiguration(classes = {
        ...
        TemporaryDirectoryConfiguration.class,
})
class TemplatingDirectoryAcceptanceTest {
    ...
    void setUpKafkaConsumer() {
        ...
        consumer.subscribe(singleton(TemplatingDirectoryAcceptanceTest.class.getSimpleName()));
    }
    ...
    private Path givenTemplate(String fileExtension,
        ...
        try {
            ...
            var templatePath = createTempFile(temporaryDirectory, "kafkabridge-" + TemplatingDirectoryAcceptanceTest.class.getSimpleName(), "." + fileExtension);
            writeString(templatePath, content);
            return temporaryDirectory.relativize(templatePath);
        } catch (IOException e) {
