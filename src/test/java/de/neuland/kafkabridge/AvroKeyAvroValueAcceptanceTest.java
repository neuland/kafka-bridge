...
class AvroKeyAvroValueAcceptanceTest {
    ...
    void setUpKafkaConsumer() {
        ...
        consumer.subscribe(singleton(AvroKeyAvroValueAcceptanceTest.class.getSimpleName()));
    }
    ...
    void shouldSendKafkaMessage() {
        ...
        var topic = AvroKeyAvroValueAcceptanceTest.class.getSimpleName();
        var recordKeySchemaSubject = ProductKey.class.getName();
        var recordKey = "{ \"code\": \"Product-0002\" }";
        ...
        assertThat(pollAllRemainingRecords(consumer)).singleElement().satisfies(consumerRecord -> {
            assertThat(consumerRecord.key().getCode()).isEqualTo("Product-0002");
